...
const output = process.env.APEXBIKE_SCREENSHOT ?? "/private/tmp/apexbike-glasses.png";
const preview = process.env.APEXBIKE_SCREENSHOT_PREVIEW ?? "/private/tmp/apexbike-glasses-black.png";
