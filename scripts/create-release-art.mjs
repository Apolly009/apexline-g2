...
function createIcon() {
  ...
  writePng(resolve(outDir, "apexline-icon.png"), surface.width, surface.height, surface.pixels);
}
...
function createBackground() {
  ...
  writePng(resolve(outDir, "apexline-background.png"), surface.width, surface.height, surface.pixels);
}

createIcon();
createBackground();
console.log("Created release-assets/apexline-icon.png and release-assets/apexline-background.png");
